...
const Tiptap = (body: Props) => {
	console.log("body", body?.body);

  // const dispatch: = useAppDispatch();
	const dispatch = useAppDispatch();

  dispatch(setText(body?.body))
	...
	const editor = useEditor({
      ...
      <ul>
        <li>
          That is a bullet list with one …
        </li>
        <li>
          … or two list items.
        </li>
      ...
      <p>
        Is not that great? And all of that is editable. But wait, there’s more. Let’s try a code block:
      </p>
  ...
  display: none;
      ...
      <blockquote>
        Wow, that is amazing. Good work, boy! 👏
        <br />
        — Mom
      </blockquote>
    `,
		...
		if (editor) {
			const updateText = () => {
				...
				if (Object.keys(body).length !== 0) {
					return dispatch(setText(body?.body));
				}
